...
export const IconOutlinedButton = memo(({ component: CustomTag = 'div', icon, children }: Props) => {
  return (
    <CustomTag
      ...
      className="block border border-primary-400 rounded text-primary-900 py-3 px-8 relative text-center cursor-pointer hover:bg-primary-400/10 active:bg-primary-400/20"
    >
